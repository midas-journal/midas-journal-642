...
//   opt->setFileOption(  "title" );
  ...
  typedef itk::AtanHeavisideFunction< ScalarPixelType, ScalarPixelType > HeavisideFunctionType;
  HeavisideFunctionType Heaviside( epsilon );
  ...
  {
    levelSetFilter->GetDifferenceFunction(i)->SetDomainFunction( &Heaviside );
    levelSetFilter->GetDifferenceFunction(i)->SetCurvatureWeight( mu );
    levelSetFilter->GetDifferenceFunction(i)->SetAreaWeight( nu );
    levelSetFilter->GetDifferenceFunction(i)->SetLambda1( l1 );
    levelSetFilter->GetDifferenceFunction(i)->SetLambda2( l2 );
    levelSetFilter->GetDifferenceFunction(i)->SetOverlapPenaltyWeight( gamma );
    levelSetFilter->GetDifferenceFunction(i)->SetLaplacianSmoothingWeight( eta );
    levelSetFilter->GetDifferenceFunction(i)->SetVolumeMatchingWeight( tau );
