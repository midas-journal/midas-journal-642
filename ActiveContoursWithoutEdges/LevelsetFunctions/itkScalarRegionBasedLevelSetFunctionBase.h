#ifndef __itkScalarRegionBasedLevelSetFunctionBase_h_
#define __itkScalarRegionBasedLevelSetFunctionBase_h_
...
public:
  ...
  itkTypeMacro( ScalarRegionBasedLevelSetFunctionBase,
